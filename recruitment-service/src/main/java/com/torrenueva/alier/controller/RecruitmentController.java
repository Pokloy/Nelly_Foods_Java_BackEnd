...
public class RecruitmentController {
	...
	@GetMapping("/find")
	public ResponseEntity<RecruitDto> getSpecificRecruit(@RequestBody RecruitDto recruiteDto){
		System.out.println(recruiteDto);
		RecruitDto dto = recruiteService.findSpecificRecruite(recruiteDto.getInvitedId());
		return ResponseEntity
				.status(HttpStatus.OK)
				.body(dto);
	}
